...
# What is the name of this app?
	define('APP_NAME', 'ChatterBox Book Club');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'kcooper@g.harvard.edu'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'kcooper@g.harvard.edu'); 

# Default DB name for this app
	define('DB_NAME', 'katecoop_p4_katecooperuk_com'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'jwoDUd2zU7vZXaBMMcQCUzsA6WprxU322fUoUMYC');
	define('TOKEN_SALT', 'GeeitJWEVAQb2r9DFfRf7dbqAvYeni6tG32QPJMm');